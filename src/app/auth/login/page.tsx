...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        if (user) {
          // Store user data for redirection
          localStorage.setItem('tsf_user', JSON.stringify(user));
  ...
  const handleGoogleLogin = () => {
    ...
    setEmail('member@tsfcommsclub.com');
    setPassword('test123');
    setTimeout(() => {
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-lg">
              ...
              <div className="space-y-1 text-xs text-slate-600">
                <p><strong>Member:</strong> member@tsfcommsclub.com / test123</p>
                <p><strong>Admin:</strong> admin@tstcommsclub.com / test123</p>
                <p><strong>Super Admin:</strong> super@tstcommsclub.com / test123</p>
              </div>
            </div>
          </CardContent>
        </Card>
